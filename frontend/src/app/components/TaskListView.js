...
const isFiltered =
  ...
  <Tooltip title="Sort by assignee" placement="top">
    ...
    backgroundColor: 'rgba(255, 255, 255, 0.05)',
            ...
            <th className="py-3 px-4  border-4 border-gray-200 w-[160px]">Status
...
<td className="py-2 px-4 border-4 border-gray-200 w-[150px] break-words whitespace-pre-wrap">{task.assign}</td>
