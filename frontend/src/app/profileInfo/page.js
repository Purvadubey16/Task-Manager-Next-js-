...
const handleChangePassowrd = (e) => {
 ...
 if (changePassword) {
    ...
    setSnackbarMessage("Password must be at least 8 characters, contain 1 uppercase letter and 1 special character");
    setSnackbarSeverity("error");
    setSnackbarOpen(true);
    return;
  }
...
<div className="p-4">
    <div className="flex justify-between mb-4  pt-2">
      <p className="bg-[#EDC824] px-3 py-2 mb-4 rounded-2xl text-white">Profile Information</p>
